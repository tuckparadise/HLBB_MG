CREATE function [dbo].[ufn_DUMaker_Letter_AV_body_generate]
...
begin	
	...
	*/
	...
	set @line4 = 'Please take note that the softcopy attachment(s) forwarded by your firm to the Bank through the solicitor portal might contain harmful contents such as Virus or Malware. Hence you are required to resubmit the form together with new attachments so that the bank can proceed further.   <br><br>' + CHAR(13)+CHAR(10)
