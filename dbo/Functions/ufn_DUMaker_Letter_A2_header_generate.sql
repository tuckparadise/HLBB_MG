CREATE function [dbo].[ufn_DUMaker_Letter_A2_header_generate]
...
begin	
	...
	set @line1 = 'Pending submission of legal documents for ' + @arn 
	/*
	set @line2 = 'Dear Customers, <br>'  + CHAR(13)+CHAR(10)
	...
	set @line4 = 'Please note that the bank has yet to receive the legal documents duly executed by you from the solicitors.       <br>' + CHAR(13)+CHAR(10)
