CREATE function [dbo].[ufn_DUMaker_Letter_A2_body_generate]
...
begin	
	...
	--set @line1 = 'Subject Header : Pending submission of legal documents from solicitors  ' 
	...
	set @line4 = 'Please note that the bank has yet to receive the legal documents from the solicitors for execution.       <br><br>' + CHAR(13)+CHAR(10)
