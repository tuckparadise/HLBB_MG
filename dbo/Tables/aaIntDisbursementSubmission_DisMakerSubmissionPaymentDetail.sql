CREATE TABLE [dbo].[aaIntDisbursementSubmission_DisMakerSubmissionPaymentDetail](
 ...
 CONSTRAINT [PK_aaIntDisbursementSubmission_DisMakerSubmissionPaymentDetail] PRIMARY KEY CLUSTERED 
(
	[arn] ASC,
	[RunningIDForCurrentSubmission] ASC,
	[BillingRunningID] ASC
