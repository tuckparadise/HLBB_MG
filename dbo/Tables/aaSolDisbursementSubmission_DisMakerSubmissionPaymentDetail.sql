CREATE TABLE [dbo].[aaSolDisbursementSubmission_DisMakerSubmissionPaymentDetail](
 ...
 CONSTRAINT [PK_aaDisbursementMakerSubmissionPaymentDetail] PRIMARY KEY CLUSTERED 
(
	[arn] ASC,
