...
begin	
	...
	begin						
		...
		*/
		...
		update aaIntDisbursementSubmission_RCOMakerSubmission
		set RCOMakerEmailAddress = @RCOMakerEmailAddress, 
			RCOMakerDecision = @RCOMakerDecision, 
			RCOMakerSubmissionCompleted = @RCOMakerSubmissionCompleted, 
			RCOMakerRejectionReason = @RCOMakerRejectionReason,	
		...
		begin
			...
			begin
				...
				values ('Progressive Billing',@arn,'Case Approved By RCO Maker',@RCOMakerEmailAddress,null,getdate(), @billingid)
			end 		 
			...
			*/
			...
			begin
				...
				update aaIntDisbursementSubmission_RCOMakerSubmissionPaymentDetail
				set RCOMakerEmail = @RCOMakerEmailAddress,
					RCOMakerApprovedDate = getdate()
				where arn = @arn 
					and BillingRunningID = 	@billingid	
			...
			begin
				...
				INSERT INTO [dbo].[aaIntDisbursementSubmission_RCOMakerSubmission_History]
				   ([arn]
				   ,[BalanceAdviceLetterApplicableFlag]
				   ,[UrgentFlag]
				   ,[LS_RedemptionDueDateFlag]
				...
				delete from aaIntDisbursementSubmission_RCOMakerSubmission
				where arn = @arn 
					and BillingRunningID = 	@billingid	
				...
				begin				
					...
					insert into aaIntDisbursementSubmission_RCOMakerSubmissionPaymentDetail_history
					select * from aaIntDisbursementSubmission_RCOMakerSubmissionPaymentDetail
					where arn = @arn 
						and BillingRunningID = 	@billingid	

					delete from aaIntDisbursementSubmission_RCOMakerSubmissionPaymentDetail
					where arn = @arn					
						and BillingRunningID = 	@billingid	
