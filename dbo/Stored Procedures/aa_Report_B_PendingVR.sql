CREATE         procedure [dbo].[aa_Report_B_PendingVR]
...
begin
	...
	*/
	...
	truncate table aaMortgageReport_PendingVR;
	...
	--begin		
		with cte (MortgateCenterCode, CreditApplicationNumber, CollateralPurpose, DisbursementManner, ApplicantName, SolicitorCode, ValuerCode, TotalFinancingAmount,
			...
			insert into aaMortgageReport_PendingVR
			(
				MortgateCenterCode, 
		...
		from aaMortgageReport_PendingVR 
	--end 	
end