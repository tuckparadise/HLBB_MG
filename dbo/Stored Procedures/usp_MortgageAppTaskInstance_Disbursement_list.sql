create   procedure [dbo].[usp_MortgageAppTaskInstance_Disbursement_list]
as
begin
  ...
  where [workflow] in ('DisbDUMakerSolicitorApproval','DisbDUCheckerSolicitorApproval','DisbDUCheckerSolicitorApproval','DisbDUCheckerSolicitorApproval')
