CREATE     procedure [dbo].[aa_SolDisbursementSubmission_DisMaker_GetUpdateInfoList]
as
begin
	...
	select 
		...
		DATEDIFF(day, ui.UpdatedDate, getdate()) as 'Ageing', 		
	...
	from aaSolDisbursementSubmission solsub		
		inner join aaSolDisbursementSubmission_UpdateInfo ui on ui.arn = solsub.arn 
		...
		left join aaSolDisbursementSubmission_DisMakerRejected rejected on rejected.arn = solsub.arn 
