create       procedure [dbo].[ddProject_NOP_Email_GetRecord]
...
begin
	...
	set @ReceiverEmail =  (
							select isnull(phaseemail,'')from ddProjectPhase
							where DeveloperCode = @DevCode
							and ProjectCode = @ProjectCode
							and PhaseCode = @PhaseCode
							/*
							select devemail from ddProjectDisbursementSubmission_NotificationOfPayment_staging_master_EDMS	
