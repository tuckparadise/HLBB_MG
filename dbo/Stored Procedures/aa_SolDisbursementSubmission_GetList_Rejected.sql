CREATE     procedure [dbo].[aa_SolDisbursementSubmission_GetList_Rejected]
...
begin
	...
	select 
		...
		DATEDIFF(day, rejected.DisbursementMakerSubmissionDate, getdate()) as 'Aging'	,
		--doc.UpdatedDate as 'Documentation Executed Date',
		FORMAT (rejected.DisbursementMakerSubmissionDate, 'dd/MM/yyyy') as 'Reject Date'
