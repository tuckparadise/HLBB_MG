...
CREATE   procedure [dbo].[aa_DisbursementCheckerRejectedLetter_generate]
...
begin	
	...
	select @SubmissionDate = DisbursementMakerSubmissionDate,
		@reasons = DisbursementCheckerRejectionReason,
		@receiver = DisbursementMakerEmailAddress
	from aaSolDisbursementSubmission_DisCheckerRejected
	where  arn = @param_arn
