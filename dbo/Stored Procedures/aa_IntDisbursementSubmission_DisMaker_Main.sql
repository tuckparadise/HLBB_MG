...
begin	
	...
	if (@Error = '')
	begin
		if (@DisbursementMakerDecision = 'Submit')
		begin
			/*
			--validate data types 
		...
		*/
		...
		begin
			...
			*/
			...
			if (@DisbursementMakerDecision = 'Submit' AND @DisbursementMakerSubmissionCompleted = 1 and @PR_DeveloperBillingDueDateFlag =1 and @DefaultSada = 1)
			begin
			...
			if ( @DisbursementMakerDecision = 'Submit' AND @DisbursementMakerSubmissionCompleted = 1 and @PR_DeveloperBillingDueDateFlag =1 and @FinalBillingFlag is null)
			begin
		...
		if (@DisbursementMakerDecision = 'Submit' and @DisbursementMakerSubmissionCompleted = 1)
		begin
			if not exists 
			(
				select 1
		...
		begin
			...
			if ( @DisbursementMakerDecision = 'Submit' and @DisbursementMakerSubmissionCompleted = 1 and @legalfeeDisburse > @legalfee)
			begin
		...
		begin
			...
			if (@DisbursementMakerDecision = 'Submit' and @DisbursementMakerSubmissionCompleted = 1 and @ValuationFeeDisburse > @ValuationFee)
			begin
		...
		begin
			...
			if (@DisbursementMakerDecision = 'Submit' and @DisbursementMakerSubmissionCompleted = 1 and @MDTAFeeDisburse > @MDTAFee)
			begin
		...
		begin
			...
			if (@DisbursementMakerDecision = 'Submit' and @DisbursementMakerSubmissionCompleted = 1  and @TotalDisbursementAmountIncludeHistory > @FinancingAmountExcludeFLVM)
			begin
