--usp_InternalUserRole_GetRoleByUser 'jasonangot'

CREATE   procedure [dbo].[usp_InternalUserRole_GetRoleByUser]
...
begin
	...
	select u.UserName,
		...
		u.[Status],
		u.UpdatedDate,
		u.IDLastLockedDatetime,
		r.[UserRoleID] as [UserRoleID]
      ,r.[UserRoleName] as [UserRoleName]
      ,r.[UserRoleDescription] as [UserRoleDescription]
	...
	from [InternalUser] u
		...
		inner join [InternalUserRole_AccessList] al on al.UserRoleID = m.UserRoleID
