CREATE         procedure [dbo].[aa_IntDisbursementSubmission_RCOMaker_GetRejectedList]
as
begin
	select 
	...
	from aaIntDisbursementSubmission IntSub 
		...
		inner join aaIntDisbursementSubmission_RCOMakerRejected rejected on rejected.arn = IntSub.arn and rejected.BillingRunningID = IntSub.BillingRunningID
