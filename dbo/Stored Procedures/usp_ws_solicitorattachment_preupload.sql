CREATE procedure [dbo].[usp_ws_solicitorattachment_preupload]
...
begin
	...
	begin
		...
		begin
			...
			values (@arn, 'SolicitorDPSubmission', @attachmentfilename, @attachmentcontent, @attachmentfiletype, getdate(), getdate(),getdate(), @checksum)
		end 
		else
		begin
