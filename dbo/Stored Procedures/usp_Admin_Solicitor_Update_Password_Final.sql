CREATE procedure [dbo].[usp_Admin_Solicitor_Update_Password_Final]
@SolicitorCode nvarchar(max),
@SolicitorEncryptedPassword nvarchar(max) = null,
...
begin
	...
	update sqlSolicitor 
	set 
		SolicitorPassword = @SolicitorEncryptedPassword,
