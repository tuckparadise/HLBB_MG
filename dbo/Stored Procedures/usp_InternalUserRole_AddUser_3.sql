CREATE     procedure [dbo].[usp_InternalUserRole_AddUser_3]
...
begin
	...
	begin
		...
		where main.UserRoleID is null and main.UserName is null 			
			and removed.UserRoleID = @UserRoleID
		...
		declare 	@OperationPrimaryKeysview nvarchar(max)
		...
		*/
		...
		if (isnull(@ConcatenatedOriginalValue,'') <> isnull(@ConcatenatedNewValue,''))
		begin
			-- insert into admin log
